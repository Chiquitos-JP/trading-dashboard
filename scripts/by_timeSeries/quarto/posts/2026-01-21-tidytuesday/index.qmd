...
This week's TidyTuesday visualizes my personal stock trading realized profit/loss in a traditional calendar format. Using ggplot2's `geom_tile()`, each day displays:
- **Date number**
...
create_calendar_heatmap <- function(data, year, title_suffix = "") {
  ...
  p <- ggplot(calendar_data, aes(x = wday, y = week_of_month)) +
    ...
    labs(
      ...
      caption = "Source: Personal trading records | Created for TidyTuesday",
      x = NULL,
      y = NULL
    ) +
    # Theme
