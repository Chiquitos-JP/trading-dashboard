...
SOURCE_NOTE = (
    "Note: Mario-branded Nintendo titles only<br>"
    "Source: VGChartz / vgsales dataset  ·  <i>© 2026 chokotto</i>"
)
...
fig.update_layout(
    **THEME,
    ...
    showlegend=False,
    height=460,
    margin=dict(t=130, b=140, l=80, r=100),
)

# サブタイトル: paper 座標で左右を明示的に分ける（x domain は重なりやすいため使わない）
LEFT_RIGHT_SPLIT = 0.42  # column_widths[0]
fig.add_annotation(
...
fig.add_annotation(
    text="Platform games lead,<br>but racing & party titles diversify the portfolio",
    xref="paper", yref="paper",
    x=LEFT_RIGHT_SPLIT + 0.03, y=1.18,
    showarrow=False,
    font=dict(size=13, color="#1e293b"),
    align="left",
    xanchor="left",
