...
# --- 2列サブプロット（subplot_titles でタイトルを各列に割り当て）---
fig = make_subplots(
    rows=1, cols=2,
    column_widths=[0.35, 0.65],
    subplot_titles=[
        f"North America drives ~{na_pct:.0f}% of global Mario revenue",
...
# subplot_titles のフォントを統一
fig.update_annotations(font=dict(size=13, color="#1e293b"))
