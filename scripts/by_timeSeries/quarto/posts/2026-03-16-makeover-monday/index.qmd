...
SOURCE_NOTE = (
    "Source: VGChartz / vgsales dataset  ·  "
...
fig.update_layout(
    **THEME,
    ...
    showlegend=False,
    height=500,
    margin=dict(t=100, b=120, l=220, r=100),
)
fig.add_annotation(
...
add_source(fig, y=-0.20)
fig.show()
fig.write_image("chart-1.png", width=1200, height=600, scale=2)
```

### Regional Mix and Genre Diversity

```{python}
#| label: regional-and-genre
#| fig-width: 11
#| fig-height: 5
...
fig.update_layout(
    **THEME,
    ...
    showlegend=False,
    height=420,
    margin=dict(t=110, b=120, l=80, r=100),
)

# サブタイトル（左）
fig.add_annotation(
    text=f"North America drives ~<b>{na_pct:.0f}%</b> of global Mario revenue",
...
# サブタイトル（右）
fig.add_annotation(
    text="Platform games lead, but racing and party titles diversify the portfolio",
...
fig.update_layout(
    **THEME,
    ...
    showlegend=False,
    height=420,
    margin=dict(t=100, b=120, l=80, r=100),
)
fig.add_annotation(
